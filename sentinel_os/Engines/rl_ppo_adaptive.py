...
class PPORouter:
    def __init__(self, graph, neighbors: Dict[str, List[str]], config: PPOConfig | None = None, expected_wait: Dict[str, float] | None = None):
        self.graph = graph
        self.neighbors = neighbors
        self.cfg = config or PPOConfig()
        self.expected_wait = expected_wait or {}
